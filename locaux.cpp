...
/**************************************/
QString locaux::getadresse()
{
    return ADRESSE;
}
QString locaux::getnom()
{
    return NOM;
}
QString locaux::getsuperficie()
{
    return SUPERFICIE;
}
int locaux::getnombreplace()
{
    return NPLACES;
}
int locaux::getprix()
...
QString locaux::getdescription()
{
    return DESCRIPTION;
}
/**************************************/
void locaux::setadresse(QString ADRESSE)
{
    this->ADRESSE=ADRESSE;
}
void locaux::setnom(QString NOM)
{
    this->NOM=NOM;
}
void locaux::setsuperficie(QString SUPERFICIE)
{
    this->SUPERFICIE=SUPERFICIE;
}
void locaux::setnomberplace(int NPLACES)
{
    this->NPLACES=NPLACES;
}
void locaux::setprix(int PRIX)
{
    this->PRIX=PRIX;
}
void locaux::setdescription(QString DESCRIPTION)
{
    this->DESCRIPTION=DESCRIPTION;
}
/**************************************/
...
QSqlQueryModel* locaux::afficher_nom()
{
    QSqlQueryModel* model=new QSqlQueryModel();
...
QString locaux::read()
{
    QFile file("C:/Users/chikh/Desktop/GestionLocaux/historylocaux.txt");
