...
void Dialog_stats::choix_bar()
{
    ...
    q2.prepare("SELECT * FROM PERSONNEL WHERE GENDER='Homme' ");
    q2.exec();

    q3.prepare("SELECT * FROM PERSONNEL WHERE GENDEF='Femme' ");
    q3.exec();

    q4.prepare("SELECT * FROM PERSONNEL WHERE GENDER='Autre' ");
    q4.exec();
...
void Dialog_stats::choix_pie()
{
    ...
    q3.prepare("SELECT * FROM PERSONNEL WHERE GENDER='Femme' ");
    q3.exec();
