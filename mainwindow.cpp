...
void MainWindow::on_pB_AjouterP_clicked()
{
    ...
    int PRIX_F=ui->edit_f->text().toInt();
    int PRIX_L=ui->edit_l->text().toInt();
...
void MainWindow::on_pb_excel_clicked()
{
    QString fileName = QFileDialog::getSaveFileName(this, tr("Excel file"), qApp->applicationDirPath (),
           ...
           ExportExcelObject obj(fileName, "mydata", ui->tab_Events);
...
{
    QPdfWriter pdf("C:/Users/MSI/OneDrive/Bureau/GestionDesEvenements/EVENEMENT.pdf");
    QPainter painter(&pdf);
    int i = 4000;
    painter.setPen(Qt::black);
    painter.setFont(QFont("Arial", 30));
    painter.drawPixmap(QRect(100,400,2000,2000),QPixmap("C:/Users/MSI/OneDrive/Bureau/GestionDesEvenements/Logo.png"));
    painter.drawText(3000,1500,"LISTE DES EVENEMENTS");
    painter.setPen(Qt::blue);
    painter.setFont(QFont("Arial", 50));
    painter.drawRect(2700,200,6300,2600);
    ...
    if (reponse == QMessageBox::Yes)
    {
        QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/MSI/OneDrive/Bureau/GestionDesEvenements/evenement.pdf"));
        painter.end();
    }
    if (reponse == QMessageBox::No)
    {
...
/*void MainWindow::on_reser_clicked()
{

    QString text;
    ui->label_Info->setText("recherche date effectué");
    ui->->tab_e(E.tri_date());
}*/
