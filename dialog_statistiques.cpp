...
q2.prepare("SELECT * FROM PERSONNEL WHERE PACK='Pack 1' ");
q2.exec();

q3.prepare("SELECT * FROM PERSONNEL WHERE PACK='Pack 2' ");
q3.exec();

q4.prepare("SELECT * FROM PERSONNEL/ WHERE PACK='Pack 3' ");
q4.exec();
